...
namespace SobekCM.Management_Tool
{
	...
	public class StartUp
	{
		...
		static void Main() 
		{
			...
			// VERSION CHECKING DISABLED - No longer checking for updates from sobekrepository.org
			...
			if (!updating)
			{
				...
				try
				{
					...
					// Try to initialize database connection and settings
					try
					{
					...
					{
						// Database connection failed - show warning but continue
						MessageBox.Show("Warning: Unable to connect to the database.\n\n" + 
							"The application will start but some features may not be available.\n\n" +
							"Error: " + dbEx.Message,
