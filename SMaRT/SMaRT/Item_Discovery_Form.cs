...
namespace SobekCM.Management_Tool
{
    ...
    public partial class Item_Discovery_Form : Form
    {
        ...
        public Item_Discovery_Form()
        {
            ...
            Text = Engine_ApplicationCache_Gateway.Settings.System.System_Abbreviation + " Item Discovery Form - (" + MainForm.CurrentDatabaseServer + ") (v" + VersionConfigSettings.AppVersion + ")";
