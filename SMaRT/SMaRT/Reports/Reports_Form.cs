...
using SobekCM.Engine_Library.Database; // for Engine_Database
using SobekCM.Engine_Library.ApplicationState; // for Engine_ApplicationCache_Gateway
using SobekCM.Management_Tool.Versioning; // for VersionConfigSettings
...
namespace SobekCM.Management_Tool.Reports
{
	...
	public class Reports_Form : Form
	{
        ...
        {
            // Show confirmation only when logging is enabled
            if (LoggingWindow.LoggingEnabled)
            {
                // Gather diagnostic information
                string dbType = MainForm.CurrentDatabaseServer;
                string connStr = Engine_Database.Connection_String;
                string version = VersionConfigSettings.AppVersion;
                string builderFolder = Engine_ApplicationCache_Gateway.Settings.Builder.Main_Builder_Input_Folder;
                string info = $"Database: {dbType}\nConnection: {connStr}\nVersion: {version}\nBuilder Folder: {builderFolder}";
